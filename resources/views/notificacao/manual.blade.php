...
@section('content')
@section('notificacao-manual','active')
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="basic-default-phone" class="form-control phone-mask"
                                    placeholder="91991968433,91991968433,91991968433,...">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-message">Menssagem</label>
                                <textarea id="basic-default-message" class="form-control"
                                    placeholder="Olá, passando pra informar que estamos com promoção ate dia 30"></textarea>
                            </div>

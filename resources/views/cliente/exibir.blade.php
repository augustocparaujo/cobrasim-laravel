          ...
          <form action="/cliente/update/{{ $cliente->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="John Doe" name="nome"
                  value="{{ $cliente->nome }}">
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                ...
                <input type="date" class="form-control" id="basic-default-nascimento" placeholder="00-00-0000"
                  name="nascimento" value="{{ $cliente->nascimento }}">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                ...
                <input type="text" id="basic-default-phone" class="form-control mobile" placeholder="(91) 99999-9999"
                  name="contato" value="{{ $cliente->contato }}">
              </div>

              <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                <label class="form-label" for="basic-default-phone2">Contato</label>
                <input type="text" id="basic-default-phone2" class="form-control mobile" placeholder="(91) 99999-9999"
                  name="contato2" value="{{ $cliente->contato2 }}">
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                ...
                <div class="input-group input-group-merge">
                  <input type="text" id="basic-default-complemento" class="form-control" placeholder="Complemento"
            ...
            <div class="mb-3">
              ...
              <textarea id="basic-default-message" class="form-control"
                placeholder="Digite aqui alguma observação ou anotação" name="obs">{{ $cliente->obs }}</textarea>
            </div>
